...
class WorkspaceUpdaterTest {

    private static final Date NOW = new Date();

    @Test
    void testGetRevisionFromTimestamp() {
    ...
    @Test
    void testRevisionFromRevisionParametersOverrideTimestamp() {
        UpdateTask updateTask = createUpdateTask();
    ...
    @Test
    void testRevisionInUrlOverridesEverything() {
        UpdateTask updateTask = createUpdateTask();
    ...
    @Test
    void testRevisionInUrlOverridesEverything_HEAD() {
        UpdateTask updateTask = createUpdateTask();
